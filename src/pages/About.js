  ...
  return (
    <section className="page">
      ...
      <Container>
        ...
        <p>I have am a resourceful and self-reliant learner who is able to swiftly learn and apply anything on my own whether it is new software, technologies, skills, methodologies, and even <Link to="/funfacts">foreign languages</Link>. While development is not the easiest subject for many to comprehend, my perseverance and positive attitude towards learning has allowed me to effectively and efficiently grasp the concepts on my own.</p>

        <p>I started my development journey through a course called <a href="https://www.udemy.com/course/the-web-developer-bootcamp/" target="_blank" rel="noreferrer">The Web Development Bootcamp</a> on <a href="https://wwww.udemy.com" target="_blank" rel="noreferrer">Udemy</a> by Colt Steele which teaches many topics such as HTML, CSS, Javascript, NodeJS, and MongoDB. In addition, I have supplemented my learning by completing the exercises and projects on <a href="https://www.freecodecamp.org" target="_blank" rel="noreferrer">FreeCodeCamp</a>'s web design module, which is a great free resource to help anyone start learning how to code.</p>

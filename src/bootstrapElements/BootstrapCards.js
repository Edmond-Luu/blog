...
export function FunFactsCard() {
    return (
        <Card style={{ width: '18rem' }} id="card">
            <Link to="/blog/blog/funfacts"><Card.Img variant="top" src={cardFacts} /></Link>
            <Card.Body>
                ...
                <div className="cardBtnContainer">
                    <Link to="/blog/funfacts"><Button variant="light" className="cardBtn" id="cardBtn">Learn More</Button></Link>
                </div>
            </Card.Body>
        </Card>
    )
...
export function SiteInfoCard() {
    return (
        <Card style={{ width: '18rem' }} id="card">
            <Link to="/blog/blog/siteinfo"><Card.Img variant="top" src={cardInfo} /></Link>
            <Card.Body>
                ...
                <div className="cardBtnContainer">
                    <Link to="/blog/siteinfo"><Button variant="light" className="cardBtn" id="cardBtn">Learn More</Button></Link>
                </div>
            </Card.Body>
        </Card>
    )
...
export function ContactCard() {
    return (
        <Card style={{ width: '18rem' }} id="card">
            <Link to="/blog/blog/contact"><Card.Img variant="top" src={cardContact} /></Link>
            <Card.Body>
                ...
                <div className="cardBtnContainer">
                    <Link to="/blog/contact"><Button variant="light" className="cardBtn" id="cardBtn">Learn More</Button></Link>
                </div>
            </Card.Body>
        </Card>
    )
...
export function AboutCard() {
    return (
        <Card style={{ width: '18rem' }} id="card">
            <Link to="/blog/blog/about"><Card.Img variant="top" src={cardAbout} /></Link>
            <Card.Body>
                ...
                <div className="cardBtnContainer">
                    <Link to="/blog/about"><Button variant="light" className="cardBtn" id="cardBtn">Learn More</Button></Link>
                </div>
            </Card.Body>
        </Card>
    )
...
export function ProjectsCard() {
    return (
        <Card style={{ width: '18rem' }} id="card">
            <Link to="/blog/blog/projects"><Card.Img variant="top" src={cardProjects} /></Link>
            <Card.Body>
                ...
                <div className="cardBtnContainer">
                    <Link to="/blog/projects"><Button variant="light" className="cardBtn" id="cardBtn">Learn More</Button></Link>
                </div>
            </Card.Body>
        </Card>
    )
